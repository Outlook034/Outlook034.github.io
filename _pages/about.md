...
I am a junior undergraduate student at **Xi'an Jiaotong-Liverpool University (XJTLU)**, where I am pursuing a degree in Computer Science/Data Science. My research interests lie in **3D/4D Reconstruction**, **3D Computer Vision**, **Depth Estimation**, **Medical Computer Vision**, and **Generative AI**.
...
Jiahao Qin<sup>1</sup>, **Kan Liu<sup>1</sup>**, Yizhuo Cai, Tianyi Ji, and Fangyu Liu

<sup>1</sup>Kan Liu and Jiahao Qin contributed equally to this work.
</div>
</div>
